<section title="Contato Cortez Telecom" id="contato">
	<div class="container">
      <div class="row">
      ...
      <div class="row text-center">
         <div class="col-md-7">
            <form action="http://localhost/CORTEZ%20TELECOM/mensagem" class="contact-form" method="post">
               <div class="row">
                  <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                           ...
                           <?php if(!empty($_SESSION['mensagem_vazio'])){
                              ...
                              <button title="Enviar a mensagem para Cortez Telecom" class="enviar btn btn-block">ENVIAR MENSAGEM</button>
